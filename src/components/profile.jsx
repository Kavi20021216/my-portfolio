...
// import ResumePDF from "../assets/Kaveetha_Randili_CV.pdf";
...
//           opacity: 0.5,
//           background:
//             "radial-gradient(800px 400px at 15% 20%, rgba(168,85,247,0.22), transparent 60%), radial-gradient(900px 500px at 85% 80%, rgba(217,70,239,0.18), transparent 60%)",
//           animation: "pulseGlow 6s ease-in-out infinite alternate, floatGlow 12s ease-in-out infinite",
//         }}
//       />
...
//         style={{
//           background:
//             "radial-gradient(1200px 600px at 10% 10%, rgba(192,132,252,0.18), transparent 60%), radial-gradient(1000px 500px at 90% 90%, rgba(168,85,247,0.15), transparent 60%)",
...
//         style={{
//           backgroundImage:
//             "linear-gradient(transparent 0 24px, rgba(255,255,255,.3) 25px 25px), linear-gradient(90deg, transparent 0 24px, rgba(255,255,255,.3) 25px 25px)",
//           backgroundSize: "25px 25px, 25px 25px",
//           backgroundPosition: "0 0, 0 0",
//           animation: "gridDrift 15s linear infinite, gridPulse 4s ease-in-out infinite",
//         }}
//       />
...
//           mixBlendMode: "screen",
//           background:
//             "radial-gradient(240px 240px at 22% 28%, rgba(192,132,252,0.28), transparent 60%), radial-gradient(320px 320px at 78% 65%, rgba(217,70,239,0.25), transparent 60%), radial-gradient(260px 260px at 45% 82%, rgba(147,51,234,0.22), transparent 60%)",
//           animation: "blobDrift 18s ease-in-out infinite, blobScale 10s ease-in-out infinite alternate",
//         }}
//       />
...
//           >
//             I love React on the frontend and Node/Express on the backend — with clean UI and solid APIs.
//           </motion.p>
...
//           >
//             {[
//               { label: "GitHub", href: "https://github.com/kaveetha", external: true },
//               { label: "LinkedIn", href: "https://www.linkedin.com/in/kaveetha", external: true },
...
//         @keyframes pulseGlow {
//           0% { 
//             filter: drop-shadow(0 0 0 rgba(168,85,247,0.3)); 
//             transform: scale(1); 
//           }
//           100% { 
...
//           }
//           33% {
//             background-position: 28% 35%, 72% 60%, 50% 75%;
//             background-size: 270px 270px, 350px 350px, 280px 280px;
//           }
//           66% {
//             background-position: 18% 32%, 82% 68%, 42% 80%;
//             background-size: 260px 260px, 330px 330px, 300px 300px;
//           }
//           100% {
//             background-position: 22% 28%, 78% 65%, 45% 82%;
//             background-size: 240px 240px, 320px 320px, 260px 260px;
...
//             filter: blur(25px) saturate(140%) hue-rotate(0deg); 
//           }
//           100% { 
//             transform: scale(1.1) rotate(5deg); 
//             filter: blur(30px) saturate(160%) hue-rotate(10deg); 
//           }
//         }
...
//         /* Gradient outline → filled hover (purple) */
//         .btn-outline-gradient {
//           background: linear-gradient(#000,#000) padding-box,
//             linear-gradient(90deg,#e879f9,#a78bfa,#8b5cf6) border-box;
...
//           background: linear-gradient(90deg,#e879f9,#a78bfa,#8b5cf6);
//           color: #000;
...
//               { label: "LinkedIn", href: "www.linkedin.com/in/kaveetha-randili-824715378", external: true },
//               { label: "Download CV", href: ResumePDF, download: "Kaveetha_Randili_CV.pdf" },
//               { label: "Email", href: "mailto:kaveetha@example.com" },
//             ].map(({ label, href, external, download }, idx) => (
//               <motion.a
